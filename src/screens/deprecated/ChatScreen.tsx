...
import { View, StyleSheet, FlatList, KeyboardAvoidingView, Platform, Switch, TouchableOpacity, Animated, ImageBackground, Image, ActivityIndicator } from 'react-native';
import { TextInput, Button, Text, Surface, IconButton, FAB, useTheme, MD3Theme } from 'react-native-paper';
