...
import { FaArchive, FaSyncAlt, FaRegClock, FaTimes } from 'react-icons/fa';
...
const MemoryManager: React.FC<MemoryManagerProps> = ({ conversationId, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] flex flex-col overflow-hidden">
        <div className="flex justify-between items-center p-4 border-b dark:border-slate-700">
          <h2 className="text-xl font-semibold">Conversation Memory</h2>
          <button 
            onClick={onClose}
